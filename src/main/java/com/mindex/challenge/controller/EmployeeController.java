...
public class EmployeeController {
    ...
    public ReportingStructure generateReportingStructure(@PathVariable String id) {
    	LOG.debug("Received generate reporting structure request create request for employee id [{}]", id);
    	
    	return employeeService.generateReportingStructure(employeeService.read(id));
    }
